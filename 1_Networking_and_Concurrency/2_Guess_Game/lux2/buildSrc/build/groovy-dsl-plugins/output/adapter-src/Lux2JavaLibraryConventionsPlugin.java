...
/**
 * Precompiled lux2.java-library-conventions script plugin.
 **/
public class Lux2JavaLibraryConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_Lux2JavaLibraryConventions").asSubclass(BasicScript.class);
